"""Explore settings page elements in detail"""
import time
...
try:
    ...
    # Go to settings page
    driver.get('https://fangdong.fun/settings')
    time.sleep(2)
    print('Settings URL:', driver.current_url)
    print('Settings title:', driver.title)

    # Get all elements on settings page
